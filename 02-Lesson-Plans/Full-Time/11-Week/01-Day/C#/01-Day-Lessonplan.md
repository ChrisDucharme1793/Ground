## Day 1 - Intro to C sharp & ASP.NET Core MVC
...
![Your first ASP.NET Core MVC application.](Images/1-default-app.png)
...
![ASP.NET Core MVC's Controllers directory.](Images/3-controllers-vstudio.png)
