...
The deployed assignment utilizes React, React Router, and an API to display a directory of employee information. The table allows students to filter by at least one property and sort by at least one property. The deployed assignment has been added to their deployed portfolio with a link provided in the submission.
